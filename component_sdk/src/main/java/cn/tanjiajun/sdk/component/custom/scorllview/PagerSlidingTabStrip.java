package cn.tanjiajun.sdk.component.custom.scorllview;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFFFF0033;   //滑动的下划线的颜色
    ...
    private int indicatorHeight = 4;  //滑动的下划线的高度
    private int indicatorPaddingBottom = 4;  //下划线与底部的padding
    ...
    private int unselectedTabTextColor = 0xFF666666;
    private int selectedTabTextColor = 0xFFFF0033;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        unselectedTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsUnselectedTabTextColor, unselectedTabTextColor);
...
//        canvas.drawRect(0, height - underlineHeight, tabsContainer.getWidth(), height, rectPaint);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            if (null != tabsContainer) {
                View selectedTab = tabsContainer.getChildAt(position);
                if (null != selectedTab && selectedTab instanceof TextView) {
                    TextView tabTv = (TextView) selectedTab;
                    tabTv.setTextColor(selectedTabTextColor);
                    for (int i = 0; i < tabsContainer.getChildCount(); i++) {
                        View childTab = tabsContainer.getChildAt(i);
                        if (null != childTab && childTab instanceof TextView && !childTab.equals(selectedTab)) {
                            TextView childTv = (TextView) childTab;
                            childTv.setTextColor(unselectedTabTextColor);
                        }
                    }
                }
            }
    ...
    public void setUnselectedTextColorResource(int resId) {
        this.unselectedTabTextColor = getResources().getColor(resId);
        updateTabStyles();
    }
