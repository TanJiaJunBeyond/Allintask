...
public class TagCloudView extends ViewGroup {
    ...
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.tag_cloud_background;
    ...
    private static final int DEFAULT_TAG_PADDING_LEFT = 15;
    private static final int DEFAULT_TAG_PADDING_TOP = 10;
    private static final int DEFAULT_TAG_PADDING_RIGHT = 15;
    private static final int DEFAULT_TAG_PADDING_BOTTOM = 10;
    ...
    private int mTagBorderHor;  /* Tag与Tag水平方向上的间距 */
    private int mTagBorderVer;  /* Tag与Tag垂直方向上的间距 */
    ...
    public TagCloudView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTagPaddingLeft = a.getDimensionPixelSize(R.styleable.TagCloudView_tcvTagPaddingLeft, DEFAULT_TAG_PADDING_LEFT);
        mTagPaddingTop = a.getDimensionPixelSize(R.styleable.TagCloudView_tcvTagPaddingTop, DEFAULT_TAG_PADDING_TOP);
        mTagPaddingRight = a.getDimensionPixelOffset(R.styleable.TagCloudView_tcvTagPaddingRight, DEFAULT_TAG_PADDING_RIGHT);
        mTagPaddingBottom = a.getDimensionPixelSize(R.styleable.TagCloudView_tcvTagPaddingBottom, DEFAULT_TAG_PADDING_BOTTOM);
    ...
    private int getSingleTotalHeight(int totalWidth, int totalHeight) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (child.getTag() != null && child.getTag() instanceof Integer) {
                if ((int) child.getTag() == TYPE_TEXT_NORMAL) {
