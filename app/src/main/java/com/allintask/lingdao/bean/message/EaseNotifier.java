...
public class EaseNotifier {
    ...
    public EaseNotifier init(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notificationChannel = new NotificationChannel(CHANNEL_ID, appContext.getString(R.string.app_name), NotificationManager.IMPORTANCE_HIGH);
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                mBuilder = new NotificationCompat.Builder(appContext, CHANNEL_ID);
            } else {
