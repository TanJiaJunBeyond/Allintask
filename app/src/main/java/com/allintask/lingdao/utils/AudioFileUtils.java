...
public class AudioFileUtils {
    ...
    private static String amrFilePath;
...
//            mAudioAMRPath = fileBasePath+"/"+AUDIO_AMR_FILENAME;
    ...
    public static void setAmrFilePath(String amrFilePath) {
        File targetDir;
        try {
            targetDir = new File(amrFilePath);
            targetDir.createNewFile();
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        AudioFileUtils.amrFilePath = amrFilePath;
    }
