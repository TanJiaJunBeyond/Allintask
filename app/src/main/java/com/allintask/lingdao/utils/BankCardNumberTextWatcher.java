...
public class BankCardNumberTextWatcher implements TextWatcher {
    ...
    public static void bind(EditText editText) {
        new BankCardNumberTextWatcher(editText, DEFAULT_MAX_LENGTH);
    }

    public static void bind(EditText editText, int maxLength) {
        new BankCardNumberTextWatcher(editText, maxLength);
    }

    public BankCardNumberTextWatcher(EditText editText, int maxLength) {
