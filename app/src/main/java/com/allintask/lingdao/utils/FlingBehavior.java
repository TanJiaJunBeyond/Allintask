...
/**
 * Created by TanJiaJun on 2018/5/21.
 */
...
public class FlingBehavior extends AppBarLayout.Behavior {
    ...
    @Override
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, AppBarLayout child, View target, int velocityX, int velocityY, int[] consumed) {
