...
import com.allintask.lingdao.ui.activity.cropimage.MonitoredActivity;
...
public class CropUtils {
    ...
    public static int getExifRotation(File imageFile) {
        ...
        try {
            ...
            Log.i("TanJiaJun", "Error getting Exif data", e);
            return 0;
        }
    }
    ...
    public static boolean copyExifRotation(File sourceFile, File destFile) {
        ...
        try {
            ...
            Log.i("TanJiaJun", "Error copying Exif data", e);
            return false;
        }
    }
