...
public class InviteMessgeDao {
	...
	public Integer saveMessage(InviteMessage message){
		return EMChatDatabaseManager.getInstance().saveMessage(message);
	}
	...
	public void updateMessage(int msgId,ContentValues values){
	    EMChatDatabaseManager.getInstance().updateMessage(msgId, values);
	}
	...
	public List<InviteMessage> getMessagesList(){
		return EMChatDatabaseManager.getInstance().getMessagesList();
	}
	
	public void deleteMessage(String from){
	    EMChatDatabaseManager.getInstance().deleteMessage(from);
	}

	public void deleteGroupMessage(String groupId) {
		EMChatDatabaseManager.getInstance().deleteGroupMessage(groupId);
	}

	public void deleteGroupMessage(String groupId, String from) {
		EMChatDatabaseManager.getInstance().deleteGroupMessage(groupId, from);
	}
	
	public int getUnreadMessagesCount(){
	    return EMChatDatabaseManager.getInstance().getUnreadNotifyCount();
	}
	
	public void saveUnreadMessageCount(int count){
	    EMChatDatabaseManager.getInstance().setUnreadNotifyCount(count);
	}
}
