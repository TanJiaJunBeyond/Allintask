...
public class CircularRevealButton extends LinearLayout {
     ...
     */
    public void setonSelected(boolean isSelected, boolean isNeedAnimation) {
        if (isSelected && ivFocuse.getVisibility() == VISIBLE) {
            return;
        }
        if (isSelected && ivFocuse.getVisibility() == INVISIBLE) {
            ...
            if (isNeedAnimation) {
                CircleAnimateUtils.handleAnimate(ivFocuse);
            }
