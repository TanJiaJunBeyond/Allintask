...
public class ContextMenuActivity extends BaseEMChatActivity {
        ...
        if (null != message) {
            ...
            if (null != messageType) {
                ...
                if (type == EMMessage.Type.TXT.ordinal()) {
                    if (message.getBooleanAttribute(CommonConstant.MESSAGE_ATTR_IS_VIDEO_CALL, false)
                            || message.getBooleanAttribute(CommonConstant.MESSAGE_ATTR_IS_VOICE_CALL, false)
