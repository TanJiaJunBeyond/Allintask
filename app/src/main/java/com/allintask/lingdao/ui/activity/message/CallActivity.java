...
public class CallActivity extends BaseEMChatActivity {
...
//                        }
    ...
    protected void saveCallRecord() {
        ...
        if(callType == 0)
            message.setAttribute(CommonConstant.MESSAGE_ATTR_IS_VOICE_CALL, true);
        else
            message.setAttribute(CommonConstant.MESSAGE_ATTR_IS_VIDEO_CALL, true);
