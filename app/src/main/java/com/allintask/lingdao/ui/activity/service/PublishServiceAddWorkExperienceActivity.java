...
import com.allintask.lingdao.presenter.service.PublishServiceAddWorkExperiencePresenter;
...
public class PublishServiceAddWorkExperienceActivity extends BaseActivity<IPublishServiceAddWorkExperienceView, PublishServiceAddWorkExperiencePresenter> implements IPublishServiceAddWorkExperienceView {
    ...
    @Override
    protected PublishServiceAddWorkExperiencePresenter CreatePresenter() {
        return new PublishServiceAddWorkExperiencePresenter();
    }
    ...
    private void initToolbar() {
        ...
        rightFirstTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isExistHonorAndQualification) {
    ...
    private void initUI() {
        contentTv.setText(getString(R.string.publish_service_add_work_experience_content));

        addPersonalInformationAdapter = new AddPersonalInformationAdapter(getParentContext(), CommonConstant.EXTRA_ADD_PERSONAL_INFORMATION_MODE_PUBLISH_SERVICE_ADD_WORK_EXPERIENCE, CommonConstant.ADD_PERSONAL_INFORMATION_TYPE_WORK_EXPERIENCE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CommonConstant.REQUEST_CODE && resultCode == CommonConstant.RESULT_CODE && null != data) {
            ...
            addPersonalInformationAdapter.checkSaveEnable(CommonConstant.ADD_PERSONAL_INFORMATION_TYPE_WORK_EXPERIENCE, position);
